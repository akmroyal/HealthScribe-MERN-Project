...
const Features = () => {
  const features = [
    ...
    },
    {
      ...
      description: "Access to certified specialists and experienced medical professionals."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
      ...
      description: "Quick and easy appointment scheduling with real-time availability."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
